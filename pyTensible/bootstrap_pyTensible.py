...
def bootstrap_pyTensible(local_logger=None):
    ...
    plugin_loader._namespace_hierarchy['pyTensible'] = Namespace(
        exported_resources['Interfaces'], exported_resources['Resources'])

    plugin_loader._provider_hierarchy['pyTensible.IPluginLoader'] = {}
    plugin_loader._provider_hierarchy['pyTensible.IPluginLoader'][
        'pyTensible.plugin_loader'] = plugin_loader

    plugin_loader._load_order.append('pyTensible')

    sys.modules['pyTensible'] = plugin_loader._namespace_hierarchy[
        'pyTensible']
